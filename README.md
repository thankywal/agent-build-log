...
| budget | [the same bill under a different name](notes/budget/the-same-bill-under-a-different-name) | the fix worked, the bill fell short of it, and the shortfall was a second connection |
